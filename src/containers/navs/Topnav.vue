<template>
  <nav class="navbar fixed-top">
    <div class="d-flex align-items-center navbar-left">
      ...
      <b-form-radio-group
        id="search-mode"
        v-model="searchRequest.mode"
        name="radio-sub-component"
      >
        <b-form-radio value="vehicle" >Vehicle</b-form-radio>
...
export default {
  ...
  methods: {
    ...
    // },
    search() {
      // this.$router.push(`${this.searchPath}?keyword=${this.searchKeyword}&mode=${this.mode}`);
      this.$store.dispatch("setSearchMode", this.searchRequest.mode);
