        ...
        <b-row>
          <b-colxx xxs="3" xl="3">
            <b-card class="mb-4" no-body>
              <b-card-body>
                <b-img :src="vehicle.picture" alt="Image" fluid rounded></b-img>
              </b-card-body>
            </b-card>
            <router-link :to="{ path: '/app/van_management' }" class="btn btn-primary mt-2" variant="primary">Back to
              Vehicle Listing</router-link>
          </b-colxx>
          <b-colxx xxs="9" xl="9">
            <b-card class="mb-4" no-body>
              <b-tabs card no-fade>
                    ...
                    <b-colxx sm="12">
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr v-if="vehicle.next_maintenance_comments">
