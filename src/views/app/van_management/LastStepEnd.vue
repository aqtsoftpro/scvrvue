  ...
  <b-card class="mb-4" no-body>
    <b-card-body class="wizard wizard-default">
      <form-wizard ref="vehicleWiz" :editing_mode="editing_mode" :done="dataDone" :last-step-end="true">
        <tab :name="$t('wizard.step-name-1')" :validate="validateStep1" :submit="submitStep1"
          :desc="$t('wizard.step-desc-1')" :selected="true">
              ...
              <b-colxx xxs="12" xs="4" lg="4">
                <b-form class="av-tooltip tooltip-label-right">
                  <b-form-group :label="$t('forms.van_management.picture_of_vehicle')">
                    <b-form-input style="display:none" type="text" v-model.trim="$v.formStep1.picture.$model"
                      :state="!$v.formStep1.picture.$error" />
                    <b-form-file @change="onFileChange" v-model.trim="$v.formStep1.picture.$model"
                      drop-placeholder="Drop file here..." accept="image/*">
                    </b-form-file>
                    <span v-if="vehicle && vehicle.picture" ref="imageText">Image already uploaded</span>
                    <b-form-invalid-feedback v-if="$v.formStep1.picture.$error"> Picture is
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model.trim="$v.formStep1.vin.$model"
                      :state="!$v.formStep1.vin.$error" />
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model.trim="$v.formStep1.reg_plate_number.$model"
                      :state="!$v.formStep1.reg_plate_number.$error" />
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model.trim="$v.formStep1.mileage.$model"
                      :state="!$v.formStep1.mileage.$error" />
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input style="display: none" type="text" v-model.trim="$v.formStep1.vehicle_type_id.$model"
                      :state="!$v.formStep1.vehicle_type_id.$error" />
                    <v-select v-model.trim="$v.formStep1.vehicle_type_id.$model"
                      :state="!$v.formStep1.vehicle_type_id.$error" label="name" :reduce="vehicle => vehicle.id"
                      aria-placeholder="Select Vehicle Type" :options="vehicle_type_options"></v-select>
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input style="display:none" type="text" v-model.trim="$v.formStep1.purchase_date.$model"
                      :state="!$v.formStep1.purchase_date.$error" />
                    <datepicker :bootstrap-styling="true" v-model.trim="$v.formStep1.purchase_date.$model"
                      :state="!$v.formStep1.purchase_date.$error" format="dd-MM-yyyy"></datepicker>
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model.trim="$v.formStep1.make.$model"
                      :state="!$v.formStep1.make.$error" />
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model.trim="$v.formStep1.model.$model"
                      :state="!$v.formStep1.model.$error" />
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model.trim="$v.formStep1.purchase_price.$model"
                      :state="!$v.formStep1.purchase_price.$error" />
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-textarea v-model.trim="$v.formStep1.vehicle_condition.$model"
                      :state="!$v.formStep1.vehicle_condition.$error"></b-textarea>
        ...
        <tab :name="$t('wizard.step-name-2')" :validate="validateStep2" :submit="submitStep2"
          :desc="$t('wizard.step-desc-2')">
          <div class="wizard-basic-step">
            <b-row>
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model.trim="$v.formStep2.seller_name.$model"
                      :state="!$v.formStep2.seller_name.$error" />
                    <span>{{ $t('forms.van_management.sellers_name') }}</span>
                    <b-form-invalid-feedback v-if="$v.formStep2.seller_name.$error"> Seller name is
                      required!</b-form-invalid-feedback>
                    <!-- </b-form-group> -->
                  </label>
                </b-form>
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model.trim="$v.formStep2.seller_address.$model"
                      :state="!$v.formStep2.seller_address.$error" />
                    <span>{{ $t('forms.van_management.sellers_address') }}</span>
                    <b-form-invalid-feedback v-if="$v.formStep2.seller_address.$error"> Seller address is
                      required!</b-form-invalid-feedback>
                    <!-- </b-form-group> -->
                  </label>
                </b-form>
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  <label class="form-group has-top-label">
                    ...
                    <b-form-input type="text" v-model="$v.formStep2.seller_contact_number.$model"
                      :state="!$v.formStep2.seller_contact_number.$error" />
                    <span>{{ $t('forms.van_management.sellers_contact_no') }}</span>
                    <b-form-invalid-feedback v-if="$v.formStep2.seller_contact_number.$error"> Seller contact number is
                      required!</b-form-invalid-feedback>
                    <!-- </b-form-group> -->
                  </label>
                </b-form>
        ...
        <tab :name="$t('wizard.step-name-3')" :validate="validateStep3" :submit="submitStep3"
          :desc="$t('wizard.step-desc-3')">
          <div class="wizard-basic-step">
            <b-row>
              <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  ...
                  <label class="form-group has-top-label">
                    <b-form-input type="text" v-model.trim="$v.formStep3.company_name.$model"
                      :state="!$v.formStep3.company_name.$error" />
                    <span>{{ $t('forms.van_management.company_name') }}</span>
                    <b-form-invalid-feedback v-if="$v.formStep3.company_name.$error"> Company name is
                      required!</b-form-invalid-feedback>
                  </label>
                  <!-- </b-form-group> -->
                </b-form>
              ...
              <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  ...
                  <label class="form-group has-top-label">
                    <b-form-input type="text" v-model.trim="$v.formStep3.policy_number.$model"
                      :state="!$v.formStep3.policy_number.$error"
                      :placeholder="$t('forms.van_management.policy_number')" />
                    <span>{{ $t('forms.van_management.policy_number') }}</span>
                    <b-form-invalid-feedback v-if="$v.formStep3.policy_number.$error"> Policy Number is
                      required!</b-form-invalid-feedback>
                  </label>
                  <!-- </b-form-group> -->
                </b-form>
              ...
              <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  ...
                  <label class="form-group has-top-label">
                    <b-form-input style="display:none" type="text" v-model.trim="$v.formStep3.policy_type_id.$model"
                      :state="!$v.formStep3.policy_type_id.$error" />
                    <v-select v-model.trim="$v.formStep3.policy_type_id.$model"
                      :state="!$v.formStep3.policy_type_id.$error" label="name" :reduce="vehicle => vehicle.id"
                      :options="policy_type_options"></v-select>
              ...
              <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  ...
                  <label class="form-group has-top-label">
                    <b-form-input style="display:none" type="text" v-model.trim="$v.formStep3.policy_start_date.$model"
                      :state="!$v.formStep3.policy_start_date.$error" />
                    <datepicker :bootstrap-styling="true" v-model.trim="$v.formStep3.policy_start_date.$model"
                      :state="!$v.formStep3.policy_start_date.$error" format="dd-MM-yyyy"></datepicker>
              ...
              <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
                <b-form class="av-tooltip tooltip-label-right">
                  ...
                  <label class="form-group has-top-label">
                    <b-form-input style="display:none" type="text" v-model.trim="$v.formStep3.policy_end_date.$model"
                      :state="!$v.formStep3.policy_end_date.$error" />
                    <datepicker :bootstrap-styling="true" v-model.trim="$v.formStep3.policy_end_date.$model"
                      :state="!$v.formStep3.policy_end_date.$error" format="dd-MM-yyyy"></datepicker>
              ...
              <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
                <b-form-group label="Road side assistance ?">
                  <b-radio-group>
                    <b-radio v-model="formStep3.road_side_assistance" value='yes'
                      :checked="formStep3.road_side_assistance == 'yes'">Yes</b-radio>
                    <b-radio v-model="formStep3.road_side_assistance" value='no'
                      :checked="formStep3.road_side_assistance == 'no'">No</b-radio>
                  </b-radio-group>
                </b-form-group>
              </b-colxx>
              <b-colxx v-if="formStep3.road_side_assistance == 'no'" xxs="12" xs="3" lg="3" class="mb-3">
                ...
                <b-form class="av-tooltip tooltip-label-right">
                  <!-- <b-form-group :label="$t('forms.van_management.policy_number')"> -->
                  <label class="form-group has-top-label">
                    <b-form-input type="text" v-model="formStep3.road_side_assistance_company"
                       />
              ...
              <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
                <label class="form-group has-top-label">
                  ...
                  <datepicker :bootstrap-styling="true"
                    v-model.trim="$v.formStep3.road_side_assistance_start_date.$model"
                    :state="!$v.formStep3.road_side_assistance_start_date.$error" format="dd-MM-yyyy"></datepicker>
              ...
              <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
                <label class="form-group has-top-label">
                  ...
                  <datepicker :bootstrap-styling="true" v-model.trim="$v.formStep3.road_side_assistance_end_date.$model"
                    :state="!$v.formStep3.road_side_assistance_end_date.$error" format="dd-MM-yyyy"></datepicker>
          ...
          <div class="wizard-basic-step">
              ...
              <b-row class="maintenance_row">
                <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                  <b-form>
                    <label class="form-group has-top-label">
                      <b-form-input style="display:none" type="text"
                        v-model.trim="formStep4.maintenance_records[index].maintenance_date" />
                      <datepicker :bootstrap-styling="true" :placeholder="$t('forms.van_management.maintenance_date')"
                        v-model="formStep4.maintenance_records[index].maintenance_date" format="dd-MM-yyyy">
                      </datepicker>
                ...
                <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                  <b-form>
                    <label class="form-group has-top-label">
                      <b-form-input v-model="formStep4.maintenance_records[index].maintenance_mileage" type="text"
                        :placeholder="$t('forms.van_management.maintenance_mileage')" />
                ...
                <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                  <b-form>
                    <label class="form-group has-top-label">
                      <v-select v-model="formStep4.maintenance_records[index].maintenance_type_id" label="name"
                        :reduce="maintenance => maintenance.id" aria-placeholder="Service Type"
                        :options="service_type_options"></v-select>
                ...
                <b-colxx xxs="12" xs="2" lg="2" class="mb-3">
                  <b-form>
                    <label class="form-group has-top-label">
                      <b-form-input v-model="formStep4.maintenance_records[index].maintenance_cost" type="text"
                        :placeholder="$t('forms.van_management.maintenance_cost')" />
                      <span>{{ $t('forms.van_management.maintenance_cost') }}</span>
                    </label>
                  </b-form>
                </b-colxx>
                <b-colxx xxs="12" xs="2" lg="2" class="mb-3"
                  v-if="formStep4.maintenance_records[index].maintenance_type_id == 1 || formStep4.maintenance_records[index].maintenance_type_id == 2">
                  <b-form>
                    <label class="form-group has-top-label">
                      <b-form-input v-model="formStep4.maintenance_records[index].maintenance_place" type="text"
                        :placeholder="$t('forms.van_management.maintenance_place')" />
                ...
                <b-colxx xxs="12" xs="2" lg="2" class="mb-3"
                  ...
                  <b-form>
                    <label class="form-group has-top-label">
                      <b-form-input v-model="formStep4.maintenance_records[index].mechanic_name" type="text"
                        :placeholder="$t('forms.van_management.mechanic_name')" />
                ...
                <b-colxx xxs="12" xs="2" lg="2" v-if="formStep4.maintenance_records[index].maintenance_type_id == 2">
                  <b-form>
                    <label class="form-group has-top-label">
                      <b-form-input v-model="formStep4.maintenance_records[index].part_replaced" type="text"
                        :placeholder="$t('forms.van_management.part_replaced')" />
                ...
                <b-colxx xxs="12" xs="2" lg="2" v-if="formStep4.maintenance_records[index].maintenance_type_id == 2">
                  <b-form>
                    <label class="form-group has-top-label">
                      <b-form-input v-model="formStep4.maintenance_records[index].part_repaired" type="text"
                        :placeholder="$t('forms.van_management.part_repaired')" />
                      <span>{{ $t('forms.van_management.part_repaired') }}</span>
                    </label>
                  </b-form>
                </b-colxx>
                <b-colxx xxs="12" xs="4" lg="4" class="mb-3"
                  v-if="formStep4.maintenance_records[index].maintenance_type_id != 3">
                  <b-form>
                    <label class="form-group has-top-label">
                      <b-form-input v-model="formStep4.maintenance_records[index].comments" type="text"
                        :placeholder="$t('forms.van_management.comments')" />
                ...
                <b-colxx xxs="12" xs="4" lg="4" class="mb-3"
                  ...
                  <b-form>
                    <label class="form-group has-top-label">
                      <v-select v-model="formStep4.maintenance_records[index].tyre_replaced" label="name"
                        :reduce="maintenance => maintenance.id" aria-placeholder="Tyres"
                        :options="tyres_replaced"></v-select>
            ...
            <b-row class="mt-4">
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form>
                  <label class="form-group has-top-label">
                    <b-form-input v-model="formStep4.next_maintenance_mileage" type="text"
                      :placeholder="$t('forms.van_management.next_maintenance_mileage')" />
              ...
              <b-colxx xxs="12" xs="4" lg="4">
                <label class="form-group has-top-label">
                  ...
                  <datepicker :bootstrap-styling="true" v-model="formStep4.next_maintenance_due_date"
                    format="dd-MM-yyyy">
                  </datepicker>
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3">
                <b-form>
                  <label class="form-group has-top-label">
                    <v-select v-model="formStep4.next_maintenance_service" label="name"
                      :reduce="maintenance => maintenance.id" aria-placeholder="Maintenance Type"
                      :options="next_maintenance_service_options"></v-select>
              ...
              <b-colxx xxs="12" xs="4" lg="4" class="mb-3" v-if="formStep4.next_maintenance_service == 'Mechanical'">
                <b-form>
                  <label class="form-group has-top-label">
                    <b-form-input v-model="formStep4.next_maintenance_comments" type="text"
                      :placeholder="$t('forms.van_management.next_maintenance_comments')" />
...
export default {
  ...
  methods: {
    ...
    onFileChange(e) {
      ...
      this.$refs.imageText.setAttribute('style', 'display:none !important;');
    },
