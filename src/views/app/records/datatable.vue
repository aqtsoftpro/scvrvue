        ...
        <b-colxx xxs="12">
            ...
            >
              ...
              <template slot="actions" slot-scope="props">
                    <!-- <b-button v-if="view"  @click="view(props.rowData)" size="sm" variant="grey">
                      <i class="simple-icon-eye"></i>
                    </b-button> -->
                    <b-button v-if="view"  @click="view(props.rowData)" v-b-modal.modalbasic variant="grey" size="sm"><i
                      class="simple-icon-eye"></i>
                    </b-button>
