<template>
  <div>
      ...
      <b-row>
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.first_name.$model"
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.last_name.$model"
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.phone_number.$model"
            ...
            <b-form-invalid-feedback v-if="$v.form.phone_number.$error">
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.address.$model"
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            ...
            <datepicker :bootstrap-styling="true" v-model="form.dob" :disabled-dates="{ from: new Date() }"
              :max-date="new Date()" format="dd-MM-yyyy"></datepicker>
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.gender.$model"
              :state="!$v.form.gender.$error" />
            <v-select v-model="form.gender" :reduce="customer => customer.id" label="name"
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.occupation.$model"
              :state="!$v.form.occupation.$error" />
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.driver_licence_number.$model"
              :state="!$v.form.driver_licence_number.$error" />
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          ...
          <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.driver_licence_front_picture.$model"
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          ...
          <b-form-input  type="text" style="display: none;" v-model.trim="$v.form.driver_licence_back_picture.$model"
        ...
        <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
          <label class="form-group has-top-label">
            ...
            <datepicker :bootstrap-styling="true" :disabled-dates="{ to: new Date() }" v-model="form.secondary_id_expiry"
    ...
    <b-row>
      <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
        <label class="form-group has-top-label">
          <v-select v-model="invitation_mode" aria-placeholder="Select Gender"
            :options="['email', 'whatsApp']"></v-select>
      ...
      <b-colxx xxs="12" xs="3" lg="3" class="mb-3">
        <b-button @click.stop="send_invitation(form.invitation_email)" variant="primary" size="sm">Send
          Invitation</b-button>
      </b-colxx>
    </b-row>
    ...
    <b-table id="customers-table" :items="customer_records" :fields="customer_fields" :per-page="perPage"
      ...
      <template #cell(actions)="data">
        ...
        <b-button @click.stop="edit_customer_record(data.item)" variant="grey" size="sm"><i
            class="simple-icon-pencil"></i></b-button>
        <b-button v-if="user.role_id == 1" @click.stop="delete_customer_record(data.item)" variant="grey" size="sm"><i
